...
class SubdistrictViewModel : ViewModel() {
    val progressSearch = MutableLiveData<Boolean>()
    val responseSearch = MutableLiveData<ResponseSearchSubdistrict>()
    ...
    fun getSearch(keyword : String){
        ...
        App.disposable!!.add(
            App.service!!.getSubdistrict(keyword)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeWith(object : DisposableSingleObserver<ResponseSearchSubdistrict>() {
                    override fun onSuccess(t: ResponseSearchSubdistrict) {
